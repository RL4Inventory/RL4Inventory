...
from scheduler.inventory_c51_baseline import ConsumerC51TorchPolicy
...
def train_dqn(args):
    ...
    all_policies['dqn_store_consumer'] = ConsumerC51TorchPolicy(env.observation_space, env.action_space_consumer, BaselinePolicy.get_config_from_env(env), dqn_config)
...
parser.add_argument("--run-name", type=str, default='1216_c51_dataset_newaction_noNorm')
