...
warehouse_config = [
    {
        ...
        "order_cost": [200, 200],
        "delay_order_penalty": [1000, 1000], 
        "downstream_facilities": [[0, 1, 2], [0, 1, 2]],
        "sku_relation": [
            [{"sku_name": "SKU1", "price": 100, "cost": 100, "service_level": 0.95, "vlt": 2, 'init_stock': 1000},
             {"sku_name": "SKU2", "price": 200, "cost": 200, "service_level": 0.95, "vlt": 2, 'init_stock': 300},
             {"sku_name": "SKU3", "price": 300, "cost": 300, "service_level": 0.95, "vlt": 2, 'init_stock': 230}
            ],
            [{"sku_name": "SKU4", "price": 400, "cost": 400, "service_level": 0.95, "vlt": 1, 'init_stock': 190},
             {"sku_name": "SKU5", "price": 250, "cost": 250, "service_level": 0.95, "vlt": 3, 'init_stock': 200},
             {"sku_name": "SKU6", "price": 500, "cost": 300, "service_level": 0.95, "vlt": 3, 'init_stock': 500}
            ]
        ]
    },
    {
        ...
        "storage_capacity": [10000, 10000, 10000],
        "order_cost": [200, 200, 200],
        "delay_order_penalty": [1000, 1000, 1000], 
        "downstream_facilities": [[0,1], [0, 1], [0,1]],
        "sku_relation": [
            [{"sku_name": "SKU1", "price": 100, "cost": 100, "service_level": 0.95, "vlt": 1, 'init_stock': 1000},
             {"sku_name": "SKU2", "price": 200, "cost": 200, "service_level": 0.95, "vlt": 1, 'init_stock': 300}
            ],
            [{"sku_name": "SKU3", "price": 300, "cost": 300, "service_level": 0.95, "vlt": 2, 'init_stock': 230},
             {"sku_name": "SKU4", "price": 400, "cost": 400, "service_level": 0.95, "vlt": 2, 'init_stock': 190}
            ],
            [{"sku_name": "SKU5", "price": 250, "cost": 250, "service_level": 0.95, "vlt": 3, 'init_stock': 200},
             {"sku_name": "SKU6", "price": 500, "cost": 300, "service_level": 0.95, "vlt": 3, 'init_stock': 500}
            ]
...
store_config = {
    ...
    "sku_relation": [
        [{"sku_name": "SKU1", "price": 220, "service_level": 0.95, "cost": 100, "sale_gamma": 50, 'init_stock': 500, 'max_stock': 400, 'backlog_ratio': 0.1},
         ...
         {"sku_name": "SKU6", "price": 600, "service_level": 0.95, "cost": 500, "sale_gamma": 20, 'init_stock': 200, 'max_stock': 400, 'backlog_ratio': 0.1}
        ],
        [{"sku_name": "SKU1", "price": 220, "service_level": 0.95, "cost": 100, "sale_gamma": 40, 'init_stock': 400, 'max_stock': 400, 'backlog_ratio': 0.1},
         {"sku_name": "SKU2", "price": 350, "service_level": 0.95, "cost": 250, "sale_gamma": 10, 'init_stock': 100, 'max_stock': 400, 'backlog_ratio': 0.1},
         {"sku_name": "SKU3", "price": 430, "service_level": 0.95, "cost": 300, "sale_gamma": 15, 'init_stock': 150, 'max_stock': 400, 'backlog_ratio': 0.1},
         {"sku_name": "SKU4", "price": 560, "service_level": 0.95, "cost": 450, "sale_gamma": 10, 'init_stock': 100, 'max_stock': 400, 'backlog_ratio': 0.1},
         {"sku_name": "SKU5", "price": 370, "service_level": 0.95, "cost": 200, "sale_gamma": 10, 'init_stock': 100, 'max_stock': 400, 'backlog_ratio': 0.1},
         {"sku_name": "SKU6", "price": 600, "service_level": 0.95, "cost": 500, "sale_gamma": 30, 'init_stock': 300, 'max_stock': 400, 'backlog_ratio': 0.1}
        ]
    ]
}
