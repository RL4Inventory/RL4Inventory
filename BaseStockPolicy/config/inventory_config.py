...
env_config = {
    ...
    'downsampling_rate': 1,
    'episod_duration': 365*4,
    'evaluation_len': 365,
    "initial_balance": 100000,
    "consumption_hist_len": 21,
    "sale_hist_len": 21,
    "sale_oracle_len": 14,
    "demand_prediction_len": 3,
    "uncontrollable_part_state_len": 31,
    "uncontrollable_part_pred_len": 3,
    "total_echelons": 4,
    "init": None, # or `rnd`, `rst` or None
    "tail_timesteps": 0,
    "training": False
}
