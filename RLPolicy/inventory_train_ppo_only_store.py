...
parser.add_argument("--premodel", type=str, 
    default='/root/ray_results/PPO_InventoryManageEnv_2020-12-08_11-16-1828rcclo9/checkpoint_160/checkpoint-160')
parser.add_argument("--run-name", type=str, default='ppo_tree_online')
